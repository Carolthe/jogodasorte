    ...
    <ScrollView contentContainerStyle={styles.container}>
        ...
        <>
          <View style={styles.header}>
            <View style={styles.iconBox}>
              <Ionicons name="mail-outline" size={30} color="#a855f7" />
            </View>
      ...
      {etapa === "codigo" && (
        <>
          <View style={styles.header}>
            <View style={styles.iconBox}>
              <Ionicons name="keypad-outline" size={30} color="#a855f7" />
            </View>
      ...
      {etapa === "nova-senha" && (
        <>
          <View style={styles.header}>
            <View style={styles.iconBox}>
              <Ionicons name="lock-open-outline" size={30} color="#a855f7" />
            </View>
...
function LabelIcon({ icon, label }: { icon: keyof typeof Ionicons.glyphMap; label: string }) {
  return (
    <View style={styles.labelRow}>
      <Ionicons name={icon} size={14} color="#a855f7" style={{ marginRight: 5 }} />
...
function ForcaSenha({ senha }: { senha: string }) {
  ...
  const cores  = ["#2e2e50", "#f87171", "#fb923c", "#a855f7", "#22c55e"];
